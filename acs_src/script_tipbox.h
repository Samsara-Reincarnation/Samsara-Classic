script "SamsaraPukeClient" (int mode, int arg1, int arg2) net clientside
{
    switch (mode)
    {
      case 0:
...
script "SamsaraTipboxClient" (int tipon, int mode) clientside
{
    int tipclass;
    int tipnum = 0;
    int pln = PlayerNumber();
...
script "SamsaraChangelog" (int changelogshit) NET CLIENTSIDE
{
