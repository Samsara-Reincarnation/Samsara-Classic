script "SamsaraMegaHealth" (int hpcount, int hpPerSec, int delayTics)
{
...
script "SamsaraRecoil" (int degrees, int ticsup, int ticsdown) clientside
{
...
script "SamsaraQPowers" (int startTime)
{
